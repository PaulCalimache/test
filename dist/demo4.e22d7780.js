...
Promise.all([(0, _utils.preloadImages)('.gallery__item-imginner'), (0, _utils.preloadFonts)('vxy2fer')]).then(function () {
  ...
  _toConsumableArray(document.querySelectorAll('a,.gallery__item-img,.gallery__item-number,#cercle')).forEach(function (link) {
...
var btn_menu_open = document.getElementById("btn_menu_open");
